...
while fields != None:
    sys.stdout.write(fields[0]+'\t'+str(fields[1])+'\t'+fields[2]+'\t'+fields[3]+'\t'+fields[4]+'\t'+fields[5]+'\t'+fields[6]+'\t')
   ...
   # SNPInfo.append(shortStr2Info(fields[4]))
    ...
    sys.stdout.write(str(SNPInfo[0][fields[3]])+'\t'+str(SNPInfo[0][fields[4]])+'\t'+str(SNPInfo[1][fields[3]])+'\t'+str(SNPInfo[1][fields[4]])+'\t')
    tmp = scipy.stats.chisquare([SNPInfo[0][fields[3]], SNPInfo[0][fields[4]]])
    sys.stdout.write(str(tmp[1])+'\t')
    tmp = scipy.stats.chisquare([SNPInfo[1][fields[3]], SNPInfo[1][fields[4]]])
    sys.stdout.write(str(tmp[1])+'\t')
