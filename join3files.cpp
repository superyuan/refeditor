...
int main(int argc, char* argv[])
{
	...
	if (argc != 10) {
		cerr << "join 3 files according to fields (1-based)" <<endl;
		cerr << "syntax:" << endl;
		cerr << "    " << argv[0] << " file1 file2 file3 file1_field1 file1_field2 file2_field1 file2_field2 file3_field1 file3_field2 > output" << endl;
		return -1;
	}
	// handle the first file
	int f1 = atoi(argv[4])-1;
	int f2 = atoi(argv[5])-1;
	if (f1>=0 && f2>=0)
	{
